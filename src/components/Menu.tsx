...
export function Menu({ open, setOpen }: IMenu) {
  return (
    <nav
      ...
      } absolute max-w-[280px] h-screen right-0 bg-[rgb(6,6,6)] z-50 overflow-hidden`}
    >
      <div className='w-[280px] border-lime-500 border-l h-full py-4 px-6 relative'>
        ...
        <div className='flex flex-col gap-6 '>
          ...
          <a href='#skills' className='links' onClick={() => setOpen(false)}>
            Habilidates
          </a>

          <a href='#projects' className='links' onClick={() => setOpen(false)}>
            Projetos
          </a>
